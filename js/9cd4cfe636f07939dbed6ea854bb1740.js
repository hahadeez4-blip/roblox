;// bundle: page___37a03f186900596d57e1bc35e8deed1e_m
;// files: Landing/DownloadTheApp/DownloadTheApp.js, utilities/dialog.js, common/deviceMeta.js

;// Landing/DownloadTheApp/DownloadTheApp.js
var Roblox=Roblox||{};Roblox.DownloadTheApp=(function(){function backupLink(){$('a.continue-in-app').on('mousedown',function(){var button=$(this);if(button.attr("href")==="robloxmobile://"){setTimeout(function(){if(document.hasFocus&&document.hasFocus()){window.location=button.data('backup-url');}},250);}});}
return{assignBackupLink:backupLink}})();$(function(){Roblox.DownloadTheApp.assignBackupLink();});
